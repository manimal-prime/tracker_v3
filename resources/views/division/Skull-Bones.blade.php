<div class="section-sub-section automenu">
    <p>It is the Golden Age of Piracy in the Angels of Death, Skull and Bones Division.</p>
...
<div class="section-sub-section automenu">
    ...
    <p> 
        <iframe class="youtube-embed" src="https://www.youtube.com/embed/aJy3FXGb6ok?feature=oembed"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen=""></iframe>
    </p>

    <p>
        <iframe class="youtube-embed" src="https://www.youtube.com/embed/_9YYYVG0YQI?feature=oembed"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen=""></iframe>
    </p>
...
<div class="section-sub-section automenu">
    ...
    <p>The division is currently found on a NA East Server.</p>
    
    <p>Our community events range from scheduled Naval Battles, to impromptu fun; including both the regular game modes and those we’ve engineered ourselves. We’re always looking for new and fun ways to keep things interesting. As we progress in the game we will host end game content and large-scale bracket competitions. </p>
</div>

<div class="section-sub-section automenu">
    <h2 id="apply-to-division">Apply to Division</h2>
    <p>In order to be eligible for membership in the Skull and Bones division, you must meet the following criteria:</p>
